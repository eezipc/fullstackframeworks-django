...
# Required temporarily to view emails in console
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# Settings for account setups
...
# Added this line because push to heroku failed
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'eezimotorcycles'
